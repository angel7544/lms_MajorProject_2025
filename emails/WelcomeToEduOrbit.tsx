...
interface WelcomeToEduOrbitProps {
  name: string;
  role: Role;
}

export const WelcomeToEduOrbit = ({ name, role }: WelcomeToEduOrbitProps) => {
  const baseUrl =
        ...
        <Container style={container}>
          <Section style={headerImageContainer}>
            <Img
              ...
              width={600}
              height={200}
              alt="EduOrbit Welcome Banner"
              style={headerImage}
            />
          </Section>
          <Section style={content}>
            <Heading style={heading}>Welcome to EduOrbit, {name}!</Heading>
...
export default WelcomeToEduOrbit;
